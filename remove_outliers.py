...
icu_stays=pd.read_csv('../../Data/MIMIC3/ICUSTAYS.csv',low_memory=False,engine='c')
icu_stays.head(3)
...
chartevents=pd.read_csv('../../Data/MIMIC3/charevents_sorted.csv',low_memory=False,engine='c')
chartevents.head(3)
...
outputevents=pd.read_csv('../../Data/MIMIC3/outputevents_sorted.csv',low_memory=False,engine='c')
outputevents.head(3)
...
chartevents.to_csv(f'../../Data/MIMIC3/chartevents_{prior_hours*24}.csv',index=False)
