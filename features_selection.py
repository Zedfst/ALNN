...
chartevents=pd.read_csv('../../Data/MIMIC3/CHARTEVENTS.csv',low_memory=False,engine='c')
chartevents.head(5)
...
chartevents.to_csv('../../Data/MIMIC3/charevents_sorted.csv',index=False)
...
outputevents=pd.read_csv('../../Data/MIMIC3/OUTPUTEVENTS.csv',engine='c',low_memory=False)
...
outputevents.to_csv('../../Data/MIMIC3/outputevents_sorted.csv',index=False)
